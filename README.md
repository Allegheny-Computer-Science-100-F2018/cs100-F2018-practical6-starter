...
# cs100-F2018-practical6-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Practical 6 in Computer Science 100. Since
...
* practicalsix/YearCheckerMain.java:
  * Features at least nine single-line comments
  * Features at least three multiple-line comments
  * Contains at least four uses of a `println(` statement
  * Contains at least four references to the `getHumanReadableAnswer` method
  * Dont not contain any markers indicating incomplete work
  * Runs correctly without crashing or producing an error
  * Runs correctly and produces exactly seven lines of output
  * Produces exactly four lines of output in the terminal
  * Produces exactly four `1452` fragments in the terminal output
  * Produces exactly three `Yes` fragments in the terminal output

* practicalsix/YearChecker.java:
  * Features at least three single-line comments
  * Features at least six multiple-line comments
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-F2018/cs100-F2018-practical6-starter.git
```
...
Starter](https://github.com/Allegheny-Computer-Science-100-F2018/cs100-F2018-practical6-starter)
