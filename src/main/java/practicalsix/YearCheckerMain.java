...
/**
 * The YearCheckerMain will construct and use the YearChecker.
 **/
...
public class YearCheckerMain {
  ...
  public static void main(String[] args) {
    ...
    // TODO: Step Four: Read in the year from the file
    System.out.println("I will read in a year between 1000 and 3000.");

    // TODO: Step Five: Construct an instance of the YearChecker class

    // TODO: Step Six: Call a method to see if it is a leap year and produce output

    // TODO: Step Seven: Call a method to see if it is an emergence year and produce output

    // TODO: Step Eight: Call a method to see if it is sunspot year and produce output

    // TODO: Step Nine: Display the closing message
  }
